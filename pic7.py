...
class background(arcade.Window):
    def __init__(self, width, height):
        ...
        self.head.set_position(150 , 370)
        self.blood = arcade.Sprite('images/blood.png')
        self.blood.set_position(230 , 370)           
        self.t1 = arcade.create_text("ห    ลื    น้     เ    บ    หั    อ", arcade.color.BLACK, 20)
        self.t2 = arcade.create_text("า    ว     ด    จ    น    ร    ว", arcade.color.BLACK, 20)
