...
class background(arcade.Window):
    def __init__(self, width, height):
        ...
        self.kiss.set_position(150 , 370)
        self.toffee = arcade.Sprite('images/toffee.png')
        self.toffee.set_position(230 , 370)           
        self.t1 = arcade.create_text("ลู    ว    ย     า    ห    พ    ป", arcade.color.BLACK, 20)
        self.t2 = arcade.create_text("า    ก     จ    ม    อ    น    ก", arcade.color.BLACK, 20)
