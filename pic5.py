...
class background(arcade.Window):
    def __init__(self, width, height):
        ...
        self.devil = arcade.Sprite('images/devil.png')
        self.devil.set_position(150 , 370)
        self.heart = arcade.Sprite('images/heart.png')
        self.heart.set_position(230 , 370)           
        self.t1 = arcade.create_text("ม    ปี    หั    น   ร     ใ    ศ", arcade.color.BLACK, 20)
        self.t2 = arcade.create_text("า    ว     สั่    จ    ก    ท    จ", arcade.color.BLACK, 20)
