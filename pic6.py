...
class background(arcade.Window):
    def __init__(self, width, height):
        ...
        self.time = arcade.Sprite('images/time.png')
        self.time.set_position(150 , 370)
        self.office = arcade.Sprite('images/office.png')
        self.office.set_position(230 , 370)           
        self.t1 = arcade.create_text("น    เ     ก    ย    ร    ล    ทํ", arcade.color.BLACK, 20)
        self.t2 = arcade.create_text("า    ว     สั่    า    ฬิ    ท    า", arcade.color.BLACK, 20)
